...
const FAQ = () => {
  return (
    <section id="faq" className="max-w-3xl mx-auto space-y-6 md:space-y-8 px-2">
      ...
      <Accordion type="single" collapsible className="space-y-3 md:space-y-4">
        <AccordionItem value="item-1" className="border-2 border-primary/20 rounded-lg px-4 md:px-6">
          <AccordionTrigger className="text-base md:text-lg font-semibold hover:text-primary text-left">
        ...
        <AccordionItem value="item-2" className="border-2 border-primary/20 rounded-lg px-4 md:px-6">
          <AccordionTrigger className="text-base md:text-lg font-semibold hover:text-primary text-left">
        ...
        <AccordionItem value="item-3" className="border-2 border-primary/20 rounded-lg px-4 md:px-6">
          <AccordionTrigger className="text-base md:text-lg font-semibold hover:text-primary text-left">
        ...
        <AccordionItem value="item-4" className="border-2 border-primary/20 rounded-lg px-4 md:px-6">
          <AccordionTrigger className="text-base md:text-lg font-semibold hover:text-primary text-left">
